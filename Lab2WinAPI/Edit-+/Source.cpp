...
LRESULT CALLBACK WndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		hEdit1 = CreateWindow(
			"Edit",         // указатель на строку зарегистрированного имени класса
			"hello",             // указатель на строку заголовка окна
			ES_AUTOHSCROLL, // стиль окна
			100,       // горизонтальная координата окна
